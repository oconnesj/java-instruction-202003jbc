...
public class MapDemoApp {
	...
	public static void main(String[] args) {
			...
			Product p2 = new Product("html","Murach's HTML Programming",52.99);
			Product p3 = new Product("mysql","Murach's MySQL Programming",54.50);
			...
			String code = "html";
			System.out.println("product retrived: "+productMap.get(code));
